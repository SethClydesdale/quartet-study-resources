  ...
  if (document.getElementById('announcement')) {
    window.GenkiAnn = {
      ...
      msg : [
        ...
        {
          content : 'Looking for more self-study resources? Visit the <a href="https://quartet.japantimes.co.jp/en/resource/">official website</a> for Quartet or check out some of the resources in the <a href="https://github.com/SethClydesdale/quartet-study-resources#resources-for-studying-japanese">readme</a> on GitHub.'
        },

        {
          content : 'Want to stay up to date on the latest changes made to Quartet Study Resources? You can follow updates via <a href="https://github.com/SethClydesdale/quartet-study-resources/commits/main">GitHub</a>, <a href="https://twitter.com/search?q=%23QuartetStudyResources%20from%3Asethc1995&src=typed_query&f=live">Twitter</a>, or <a href="https://ko-fi.com/sethc95/posts">Ko-fi</a>. Feel free to also contact us on <a href="https://github.com/SethClydesdale/quartet-study-resources/issues">GitHub\</a> if you have any questions or feedback.'
        },

        {
          content : 'Have a question about the site? Check out the <a href="' + getPaths() + 'help/">FAQ</a>! If you can\'t find an answer to your question, feel free to contact us via <a href="https://github.com/SethClydesdale/quartet-study-resources/issues">GitHub\'s issues</a> and we\'ll try to answer your question in a timely manner.'
        },
        ...
        {
          content : 'Don\'t have a network connection all the time? Quartet Study Resources can be used offline as well! Head on over to the <a href="' + getPaths() + 'download/">download page</a> to get the latest release.'
        },

        {
          content : 'If you found this tool helpful for studying with Quaret, please consider making <a href="' + getPaths() + 'donate/">a donation</a> to help support my work. Thank you!'
        }
      ],
